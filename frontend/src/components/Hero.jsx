...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    // Jasmine flowers (Kerala's sacred flower)
    const jasmineCount = 40;
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Lotus Petals (Kerala Temple Flower) */}
      ...
      {/* Floating Diyas (Traditional Kerala Oil Lamps) */}
      <div className="absolute inset-0 pointer-events-none">
        {diyas.map((diya) => (
          <motion.div
            key={`diya-${diya.id}`}
