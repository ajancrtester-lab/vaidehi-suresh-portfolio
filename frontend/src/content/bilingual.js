export const content = {
  en: {
    ...
    training: {
      ...
      musicTraining: [
        {
          title: "14 Years Training in Sopana Sangeetham & Idakka",
          description: "Intensive training in traditional Kerala temple music and percussion instruments."
        },
        {
          title: "Carnatic Music Training",
          description: "Foundation in South Indian classical music traditions."
        },
        {
          title: "Kathakali Sangeetham Training",
          description: "Specialized training in the musical aspects of Kerala's classical dance-drama form."
        }
      ],
  ...
  ml: {
    ...
    hero: {
      ...
      description: "13 വർഷത്തിലധികം പരിചയമുള്ള സോപാന സംഗീതത്തിന്റെ സമർപ്പിത അഭ്യാസി, കേരളത്തിന്റെ പവിത്രമായ ക്ഷേത്ര പാരമ്പര്യങ്ങളിൽ ആഴത്തിൽ വേരൂന്നിയത്. ഏകദേശം 750 ക്ഷേത്രങ്ങളിൽ അവതരിപ്പിച്ച കലാകാരി ഈ ദിവ്യ സംഗീത പൈതൃകത്തെ ഭക്തിയോടും അച്ചടക്കത്തോടും കൂടി സംരക്ഷിക്കുകയും ഉയർത്തുകയും ചെയ്യുന്നു.",
      cta: "ഇപ്പോൾ കേൾക്കൂ",
      scroll: "സ്ക്രോൾ",
      stats: {
        years: "വർഷം",
    ...
    buttons: {
      ...
      bookPerformance: "ബുക്ക് ചെയ്യുക",
      submitBooking: "ബുക്കിംഗ് അയയ്ക്കുക",
      accept: "അംഗീകരിക്കുക",
      decline: "നിരസിക്കുക"
    },
...
introParagraph: "ആധികാരിക സോപാന സംഗീത പാരമ്പര്യത്തിൽ പരിശീലനം നേടിയ വൈദേഹി സുരേഷ് കേരള ക്ഷേത്ര സംഗീതത്തിന്റെ സമ്പന്നമായ വംശപരമ്പരയെ പ്രതിനിധീകരിക്കുന്നു. സോപാന സംഗീതവുമായി ബന്ധപ്പെട്ട പരമ്പരാഗത വിദ്യാഭ്യാസ കേന്ദ്രങ്ങളിലൂടെയും പ്രശസ്ത ഗുരുവായ ഏലൂർ ബിജുവിന്റെ കീഴിലുള്ള ആത്മാർത്ഥമായ പരിശീലനത്തിലൂടെയും, ആധികാരിക ക്ഷേത്ര സംഗീത പാരമ്പര്യങ്ങളുടെ സംരക്ഷണവും പ്രചരണവും അവർ ഉറപ്പാക്കുന്നു. സോപാന സംഗീതത്തിന്റെ ശുദ്ധതയും ഭക്തിപരമായ സാരാംശവും നിലനിർത്തിക്കൊണ്ട് പരമ്പരാഗത കേരള ക്ഷേത്ര സംഗീത സാങ്കേതികതകളുമായി ശാസ്ത്രീയ കർണാടക പരിശീലനം അവർ സംയോജിപ്പിക്കുന്നു."      formalEducation: "ഔപചാരിക വിദ്യാഭ്യാസം",
      ...
      musicTraining: [
        {
          title: "14 വർഷത്തെ സോപാന സംഗീത & ഇടയ്ക്ക പരിശീലനം",
          description: "പരമ്പരാഗത കേരള ക്ഷേത്ര സംഗീതത്തിലും താള വാദ്യങ്ങളിലും തീവ്രമായ പരിശീലനം."
        },
        {
          title: "കർണാടക സംഗീത പരിശീലനം",
          description: "ദക്ഷിണേന്ത്യൻ ശാസ്ത്രീയ സംഗീത പാരമ്പര്യങ്ങളിലെ അടിസ്ഥാനം."
        },
        {
          title: "കഥകളി സംഗീത പരിശീലനം",
          description: "കേരളത്തിന്റെ ശാസ്ത്രീയ നൃത്തനാടകത്തിന്റെ സംഗീത വശങ്ങളിൽ പ്രത്യേക പരിശീലനം."
        }
      ],
    ...
    services: {
      ...
      intro: "സമർപ്പിത സോപാന സംഗീത കലാകാരി എന്ന നിലയിൽ, വിവിധ അവസരങ്ങളിൽ ആധികാരിക കേരള ക്ഷേത്ര സംഗീത അവതരണങ്ങൾ ഞാൻ നൽകുന്നു. 13+ വർഷത്തെ അനുഭവത്തോടെ, കേരളത്തിലുടനീളമുള്ള ക്ഷേത്രങ്ങളിലേക്കും സാംസ്കാരിക പരിപാടികളിലേക്കും സ്വകാര്യ ചടങ്ങുകളിലേക്കും പരമ്പരാഗത രാഗങ്ങളുടെ ദിവ്യമായ സ്വരങ്ങൾ ഞാൻ കൊണ്ടുവരുന്നു.",
      footer: "തൃശൂർ, കേരളത്തിൽ നിന്നുള്ള പ്രശസ്ത സോപാന സംഗീത കലാകാരിയാണ്, പരമ്പരാഗത ക്ഷേത്ര സംഗീത അവതരണങ്ങളിൽ വൈദഗ്ധ്യമുള്ളവരാണ്. മധ്യമാവതി, മോഹന, ഭൈരവി തുടങ്ങിയ ശാസ്ത്രീയ രാഗങ്ങളിൽ വൈദഗ്ധ്യമുള്ളവരാണ്, ഗുരുവായൂർ, തൃശൂർ എന്നിവ ഉൾപ്പെടെ കേരളത്തിലുടനീളമുള്ള പ്രധാന ക്ഷേത്രങ്ങളിലേക്ക് ആധികാരിക ഭക്തി സംഗീതം കൊണ്ടുവരുന്നു. കേരളത്തിലുടനീളം ഇന്ത്യയിലും ബുക്കിംഗുകൾക്ക് ലഭ്യമാണ്.",
      items: [
        {
